  ...
  fields: [
    ...
    { key: "name", dbColumn: "name", label: "Name", type: "text", required: true, tableColumn: true },
    {
      ...
      options: [
        ...
        "midge",
        "other",
        // Legacy title-case values still present on some rows
        "Dry Fly",
        "Nymph",
        "Wet Fly",
        "Emerger",
    ...
    { key: "recipeNotes", dbColumn: "recipe_notes", label: "Recipe Notes", type: "textarea", fullWidth: true },
    { key: "imitates", dbColumn: "imitates", label: "Imitates", type: "string-array", placeholder: "e.g. mayflies, midges" },
    { key: "effectiveSpeciesIds", dbColumn: "effective_species_ids", label: "Effective Species IDs", type: "string-array" },
    { key: "waterTypes", dbColumn: "water_types", label: "Water Types", type: "string-array", placeholder: "e.g. tailwater, freestone, spring creek" },
    {
      key: "optionEnvelope",
      dbColumn: "option_envelope",
      label: "Option Envelope (sizes, colors, bead, hook)",
      type: "json",
      fullWidth: true,
    },
    ...
    { key: "galleryImageUrls", dbColumn: "gallery_image_urls", label: "Gallery Image URLs", type: "string-array" },
    { key: "videoUrl", dbColumn: "video_url", label: "Video URL", type: "url" },
    { key: "originCredit", dbColumn: "origin_credit", label: "Origin Credit", type: "text" },
    { key: "inspiredByFlyId", dbColumn: "inspired_by_fly_id", label: "Inspired By Fly ID", type: "text" },
    {
      key: "status",
      dbColumn: "status",
      label: "Status",
      type: "select",
      required: true,
      options: ["approved", "pending", "rejected", "private"],
      tableColumn: true,
    },
    { key: "rejectReason", dbColumn: "reject_reason", label: "Reject Reason", type: "textarea", fullWidth: true },
    { key: "submittedByUserId", dbColumn: "submitted_by_user_id", label: "Submitted By User ID", type: "text" },
    { key: "approvedByUserId", dbColumn: "approved_by_user_id", label: "Approved By User ID", type: "text" },
    { key: "approvedAt", dbColumn: "approved_at", label: "Approved At", type: "text" },
    { key: "isFeatured", dbColumn: "is_featured", label: "Featured", type: "boolean", tableColumn: true },
    { key: "createdAt", dbColumn: "created_at", label: "Created At", type: "text", readOnly: true },
    { key: "updatedAt", dbColumn: "updated_at", label: "Updated At", type: "text", readOnly: true },
    { key: "deletedAt", dbColumn: "deleted_at", label: "Deleted At", type: "text", readOnly: true },
  ],
};
