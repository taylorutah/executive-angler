...
const SPECIES_COLORS = ["#0BA5C7", COPPER_700, "#2EA44F", "#A855F7", "#F59E0B", "#EC4899", "#6366F1", "#14B8A6"];
                ...
                <div className="h-48">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={catchRateData} margin={{ top: 4, right: 4, bottom: 0, left: 0 }}>
                      ...
                      />
                      <Area type="monotone" dataKey="fish" stroke={COPPER_700} strokeWidth={2} fill="url(#catchGrad)" dot={false} activeDot={{ r: 4, fill: COPPER_700, stroke: "#0D1117", strokeWidth: 2 }} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              ) : (
