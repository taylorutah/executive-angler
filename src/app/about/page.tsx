...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: brandedTitle("Fly Fishing Resource & Fishing Log"),
    description: desc,
    alternates: { canonical: `${SITE_URL}/about` },
    openGraph: {
      title: "Fly Fishing Resource & Fishing Log | Executive Angler",
      description: desc,
  ...
  return (
    <div className="py-14 sm:py-24">
      <div className="mx-auto max-w-[var(--prose)] px-4 sm:px-6">
        ...
        <div className="mt-8 space-y-6 text-[var(--text-2)] [&_strong]:font-semibold [&_strong]:text-[var(--text-1)]">
