  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        disabled={!!loading}
        className={`ea-focus-ring ${FOCUS_VISIBLE} flex w-full items-center justify-center gap-3 rounded-[2px] border border-[var(--border-rule)] bg-[var(--surface-raised)] px-4 py-3 font-ui text-sm font-medium text-[var(--text-primary)] hover:border-[var(--action)] disabled:opacity-50`}
      >
        {loading === "google" ? (
