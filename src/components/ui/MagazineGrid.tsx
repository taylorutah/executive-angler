    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2">
        {imageUrl && !iconOnly ? (
          ...
          <div className="h-64 md:h-auto bg-[#E8923A]/5 flex items-center justify-center">
            <div className="w-16 h-16 rounded-full bg-[#E8923A]/10 flex items-center justify-center">
              <MapPin className="h-8 w-8 text-[#E8923A]" />
            </div>
          </div>
        )}
