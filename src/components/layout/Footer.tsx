          ...
          <div className="max-w-md">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a
                ...
                className="group inline-flex h-[52px] items-center gap-3 rounded-xl border border-[var(--border-strong)] bg-[var(--surface-raised)] px-4 transition-all hover:border-[var(--action)]/60 hover:bg-[var(--surface-card)]"
              ...
              <div
                className="inline-flex h-[52px] items-center gap-3 rounded-xl border border-[var(--border-rule)] bg-[var(--surface-raised)]/60 px-4 cursor-default select-none"
                aria-label="Google Play — coming soon"
              >
                <svg viewBox="0 0 24 24" className="h-7 w-7 text-[var(--text-meta)]" fill="currentColor" aria-hidden="true">
                ...
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-[10px] uppercase tracking-wider text-[var(--text-meta)]">
                    Get it on
                  </span>
                ...
                <span className="ml-1 rounded-md bg-[var(--action)]/15 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-[var(--action)]">
                  Soon
                </span>
              </div>
            </div>
