    ...
    <div className="flex flex-wrap items-center gap-2 mb-4">
      ...
      <div className="relative flex-1 min-w-[200px] max-w-md">
        ...
        <input
          ...
          className="w-full rounded-md border border-[var(--color-border)] bg-transparent pl-8 pr-3 py-2 text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--action)]/40"
        />
      </div>
